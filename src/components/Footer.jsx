    ...
    <footer className="border-t border-slate-200 py-8 mt-12">
      <div className="container grid md:grid-cols-3 gap-6 items-center">
        ...
        <div className="flex gap-4 justify-end">
          <a href="mailto:info@foreleadsleadership.com" className="hover:text-navy"><FaEnvelope/></a>
          <a href="https://www.youtube.com/@ForeleadsLeadershipConsulting" target="_blank" rel="noopener noreferrer" className="hover:text-navy"><FaYoutube/></a>
          <a href="https://www.linkedin.com/in/" target="_blank" rel="noopener noreferrer" className="hover:text-navy"><FaLinkedin/></a>
        </div>
      </div>
    </footer>
  );
